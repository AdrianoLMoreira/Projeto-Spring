...
import br.com.petwebapp.services.ClienteService;
...
public class ClienteResource {
	...
	public ResponseEntity<Cliente> delete(@PathVariable Integer id) throws ObjectNotFoundException, DataIntegrityException {
